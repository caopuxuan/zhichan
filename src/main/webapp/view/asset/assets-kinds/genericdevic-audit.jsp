...
<div class="yusuan-up" style="margin-top: 10px">
    ...
    <div class="main-serice" style="width: 98%;height: 400px;margin: 30px auto;clear: both;overflow: auto;border: 1px solid #ccc">
        ...
        <div class="first-tabcont shenke-b1">
            ...
            <div class="line1 clearfix">
                <div class="lineleft pcType">
                    <label>台式机分类：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineleft informationType">
                    <label>信息化设备分类：</label>
                    <span>fafsd</span>
                </div>
            </div>
        ...
        <div class="first-tabcont shenke-b1">
            ...
            <div class="line1 clearfix">
                ...
                <div class="lineleft maintenanceCall">
                    <label>维修电话：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                ...
                <div class="lineleft mainParameter">
                    <label>主要参数：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                ...
                <div class="lineleft manufacturer">
                    <label>生产厂家：</label>
                    <span>fafsd</span>
                </div>
            </div>
        ...
        <div class="first-tabcont shenke-b1">
            <div class="line1 clearfix">
                <div class="lineleft deviceCoding">
                    <label>信息设备编码：</label>
                    <span>fafsd</span>
                </div>
...
<script>
    ...
    var grid8=mini.get("form9");
			...
			//财务信息
				...
				//台式机分类
				var pcfl = text.asset.pcType; 
				$('.first-tabcont .line1 .pcType span').html(pcfl);
				//信息化设备分类
				var xxhsbfl = text.asset.informationType; 
				$('.first-tabcont .line1 .informationType span').html(xxhsbfl);
			...
			//其他信息
				//信息设备编码
				var xxsbcode = text.asset.deviceCoding; 
				$('.first-tabcont .line1 .deviceCoding span').html(xxsbcode);
				//自定义编码
