...
<div class="yusuan-up" style="margin-top: 10px">
    ...
    <div class="main-serice" style="width: 98%;height: 400px;margin: 30px auto;clear: both;overflow: auto;border: 1px solid #ccc">
        ...
        <div class="first-tabcont shenke-b1">
            ...
            <div class="line1 clearfix">
                <div class="lineleft habitats">
                    <label>产地：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright genera">
                    <label>纲属科：</label>
                    <span>fafsd</span>
                </div>
            </div>
...
<script>
    ...
    var grid8=mini.get("form9");
			...
			//财务信息
				...
				//单价
				var djia = text.asset.unitPrice; 
				$('.first-tabcont .line1 .unitPrice span').html(djia);
				//原值
			...
			//购置信息	
				...
				//出生、栽种日期
				var cszj = ChangeDateFormat(text.asset.addYears); 
				$('.first-tabcont .line1 .addYears span').html(cszj);
				//产地
				var cd = text.asset.habitats; 
				$('.first-tabcont .line1 .habitats span').html(cd);
				//纲属科
				var gsk = text.asset.genera; 
				$('.first-tabcont .line1 .genera span').html(gsk);
