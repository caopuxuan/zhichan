    ...
    <div class="main-serice" style="width: 98%;height: 400px;margin: 30px auto;clear: both;overflow: auto;border: 1px solid #ccc">
        ...
        <div class="first-tabcont shenke-b1">
            ...
            <div class="line1 clearfix">               
                ...
                <div class="lineright antiquesLv">
                    <label>文物等级：</label>
                    <span>fafsd</span>
                </div>
            ...
            <div class="line1 clearfix">               
                ...
                <div class="lineright collectionAge">
                    <label>藏品年代：</label>
                    <span>fafsd</span>
                </div> 
                <div class="lineright sourceArea">
                    <label>来源地：</label>
                    <span>fafsd</span>
                </div>
...
<script>
    ...
    var grid8=mini.get("form9");
			...
			//财务信息
				...
				//文物等级
				var wwdj = text.asset.antiquesLv; 
				$('.first-tabcont .line1 .antiquesLv span').html(wwdj);
				//藏品年代
				var cpage = text.asset.collectionAge; 
				$('.first-tabcont .line1 .collectionAge span').html(cpage);
				//来源地
				var lyd = text.asset.sourceArea; 
				$('.first-tabcont .line1 .sourceArea span').html(lyd);
				//折旧状态
