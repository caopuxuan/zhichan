    ...
    <div class="main-serice" style="width: 98%;height: 400px;margin: 30px auto;clear: both;overflow: auto;border: 1px solid #ccc">
        ...
        <div class="first-tabcont shenke-b1">
            ...
            <div class="line1 clearfix">
                ...
                <div class="lineright postingDate">
                    <label>财务入账日期：</label>
                    <span>fafsd</span>
                </div>                
            </div>
        ...
        <div class="first-tabcont shenke-b1">
            ...
            <div class="line1 clearfix">
            	<div class="lineleft fileNumber">
                    <label>档案号：</label>
                    <span>fafsd</span>
                </div>
            	<div class="lineright supplier">
                    <label>供应商：</label>
                    <span>fafsd</span>
               </div>               
            </div>
            ...
            <div class="line1 clearfix">
                <div class="lineleft press">
                    <label>出版社：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright publicationDate">
                    <label>出版日期：</label>
                    <span>fafsd</span>
                </div>
            </div>
...
<script>
    ...
    var grid8=mini.get("form9");
			...
			//财务信息
				...
				//单价
				var danjia = text.asset.unitPrice; 
				$('.first-tabcont .line1 .unitPrice span').html(danjia);
				//原值
				...
				//折旧状态
				var zjstatu = text.asset.depreciationState; 
				$('.first-tabcont .line1 .depreciationState span').html(zjstatu);
				//净值
				var jz = text.asset.equity; 
				$('.first-tabcont .line1 .equity span').html(jz);
				//采购组织形式
			...
			//购置信息	
				...
				//档案号
				var dah = text.asset.fileNumber; 
				$('.first-tabcont .line1 .fileNumber span').html(dah);
				//供应商
				var gys = text.asset.supplier; 
				$('.first-tabcont .line1 .supplier span').html(gys);
				//出版社
				var cbs = text.asset.press; 
				$('.first-tabcont .line1 .press span').html(cbs);
				//出版日期
				var cbdate = ChangeDateFormat(text.asset.publicationDate); 
				$('.first-tabcont .line1 .publicationDate span').html(cbdate);
				//地址
