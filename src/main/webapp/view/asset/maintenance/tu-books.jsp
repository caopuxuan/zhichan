                ...
                <div class="mini-tabs" activeIndex="0"  style="width:100%;height:480px;">
                        ...
                        <div class="first-tabcont" id="firstForm">
                            ...
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineright boxline" style="display: none;">
                                    <label>资产大类</label>
                                    <input name="assetFirst" class="mini-textbox" style="width:100%" readonly value="8"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div title="购置信息">
                        <div class="first-tabcont" id="secondForm">
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>档案号</label>
                                    <input name="fileNumber" class="mini-textbox" style="width:100%"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>供应商</label>
                                ...
                                <div class="lineright boxline">
                                    <label>出版社</label>
                                    <input name="press" class="mini-textbox" style="width:100%"/>
                                </div>
                            </div>
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>出版日期</label>
                                    <input name="publicationDate" class="mini-datepicker" style="width:100%"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div title="辅助信息">
                        <div style="margin: 10px auto" id="fivthForm">
                            ...
                            <div id="datagrid1" class="mini-datagrid" style="width:96%;height:200px;margin: 0 auto;" allowResize="false" multiSelect="false"
                        ...
                        <div style="margin: 20px auto">
                            ...
                            <div id="datagrid2" class="mini-datagrid" style="width:96%;height:200px;margin: 0 auto" allowResize="false" multiSelect="false"
                                 showPager="false" allowCellEdit="true" allowCellSelect="true">
                                <div property="columns">
                                    <div header="资产附属文件" align="center" headerAlign="center">
                                        <div property="columns">
                                            <div field="name" id=this._id name="name" width="100" align="center" headerAlign="center">附件名称</div>
                                            <div field="described" name="described" width="100" align="center" headerAlign="center">附件概述
                                            <input property="editor" class="mini-textbox" style="width:100%;" minWidth="200" />
                                            </div>
                                            <div field="upload" name="upload123" width="100" align="center" headerAlign="center" renderer="onActionRenderer">附件上传</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
	...
	load();
	    ...
	    function onActionRenderer(e) {
			...
			//var s = '<div class="report-file"><span class="fielspan">选择文件</span><input class="file-prew" type="file" name="upload"/></div>';	  
			var s = "<div class='report-file'><span class='fielspan'>选择文件</span></div><input class='file-prew' type='file' name='upload'/>";	  
	        return s;	       
	    }
	    //赋值 附件名称
