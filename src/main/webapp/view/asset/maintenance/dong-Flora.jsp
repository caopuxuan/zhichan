                        ...
                        <div class="first-tabcont" id="firstForm">
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>类别名称</label>
                                    <input id="combo1" name="className" class="mini-buttonedit" style="width:100%" required="true" textField="valued" valueField="types"  emptyText="请选择..."  onbuttonclick="onButtonEdit"                            allowInput="false" popupHeight="100px"/>
                                </div>
                            ...
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineright boxline">
                                    <label>折旧状态</label>
                                    <input id="combo4" name="depreciationState" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('zjzt','combo4')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>
                            </div>
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                ...
                                <div class="lineright boxline">
                                    <label>价值类型</label>
                                    <input id="combo5" name="valueType" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('jzlx','combo5')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>经费来源</label>
                            ...
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineright boxline" style="display: none;">
                                    <label>资产大类</label>
                                    <input name="assetFirst" class="mini-textbox" style="width:100%" readonly value="10"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div title="购置信息">
                        <div class="first-tabcont" id="secondForm">
                            ...
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>出生/栽种年份</label>
                                    <input name="addYears" class="mini-textbox" style="width:100%"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>产地</label>
                                    <input name="habitats" class="mini-textbox" style="width:100%"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>纲属科</label>
                                    <input name="genera" class="mini-textbox" style="width:100%"/>
                                </div>
                            </div>
                        </div>
                    </div>
