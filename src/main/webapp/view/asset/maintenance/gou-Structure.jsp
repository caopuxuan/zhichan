                ...
                <div class="mini-tabs" activeIndex="0"  style="width:100%;height:480px;">
                    <div title="财务信息">
                        <div class="first-tabcont" id="firstForm">
                            ...
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineright boxline">
                                    <label>折旧状态</label>
                                    <input id="combo5" name="depreciationState" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('zjzt','combo5')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>
                            </div>
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>总建筑面积</label>
                                    <input name="totalFloorage" class="mini-textbox" style="width:100%" required="true"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>使用面积</label>
                            ...
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>经费来源</label>
                                    <input id="combo6" name="fundingSources" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('jfly','combo6')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>财政性资金</label>
                            ...
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineright boxline" style="display: none;">
                                    <label>资产大类</label>
                                    <input name="assetFirst" class="mini-textbox" style="width:100%" readonly value="3"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div title="购置信息">
                        <div class="first-tabcont" id="secondForm">
                            ...
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineright boxline">
                                    <label>权属性质</label>
                                    <input id="combo9" name="ownershipNature" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('qsxz','combo9')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>
                            </div>
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                    ...
                    <div title="使用信息">
                        <div class="first-tabcont" id="thirdForm">
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>使用部门</label>
                                    <input id="combo10" name="useDepartment" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('sybm','combo10')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>使用人名称</label>
                                ...
                                <div class="lineright boxline">
                                    <label>使用方向</label>
                                    <input id="combo11" name="useDirection" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('syfx','combo11')" popupHeight="100px" required="true" onvalidation="onComboValidation"/>
                                </div>
                            </div>
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>使用状态</label>
                                    <input id="combo12" name="usingState" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('syzt','combo12')" popupHeight="100px" required="true" onvalidation="onComboValidation"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>购置时间</label>
                    ...
                    <div title="其他信息">
                        <div class="first-tabcont" id="fourthForm">
                            <div class="line1 clearfix ">
                                ...
                                <!--<div class="lineright boxline">
                                    <label>资产调拨状态</label>
                                    <input id="combo13" name="stateAssetAllocation" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('zcdbzt','combo13')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>-->
                    ...
                    <div title="辅助信息">
                        ...
                        <div style="margin: 20px auto">
                            ...
                            <div id="datagrid2" class="mini-datagrid" style="width:95%;height:200px;margin: 0 auto" allowResize="false"
...
<script>
	...
	load();
		...
		combobox('jfly','combo6');//经费来源
		combobox('cgzzxs','combo7');//采购组织方式
		combobox('zjzt','combo5');//折旧状态
		combobox('rzxs','combo8');//入账形式
		combobox('qsxz','combo9');//权属性质
		combobox('jzjg','combo20');//建筑结构
		combobox('sybm','combo10');//使用部门
		combobox('syfx','combo11');//使用方向
		combobox('syzt','combo12');//使用状态
//		combobox('zcdbzt','combo14');//资产调拨状态
