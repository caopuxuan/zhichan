...
<div class="yusuan-up" style="margin-top: 10px">
    ...
    <div class="main-serice" style="width: 98%;height: 400px;margin: 30px auto;clear: both;overflow: auto;border: 1px solid #ccc">
        ...
        <div class="first-tabcont shenke-b1">
            ...
            <div class="line1 clearfix">
                <div class="lineleft carPrice">
                    <label>裸车价：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineleft purchaseTax">
                    <label>购置税：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                <div class="lineleft otherExpenses">
                    <label>其它上户费用：</label>
                    <span>fafsd</span>
                </div>
            ...
            <div class="line1 clearfix">
                <div class="lineleft specificationModel">
                    <label>规格型号：</label>
                    <span>fafsd</span>
                </div>
            </div>
        ...
        <div class="first-tabcont shenke-b1">
            ...
            <div class="line1 clearfix">
                <div class="lineleft labelType">
                    <label>厂牌型号：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright origin">
                    <label>车辆产地：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                <div class="lineleft afterService">
                    <label>售后服务内容：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright contractNumber">
                    <label>合同编号：</label>
                    <span>fafsd</span>
                </div>
            </div>
        ...
        <div class="first-tabcont shenke-b1">
            ...
            <div class="line1 clearfix">
                <div class="lineleft plateNumber">
                    <label>车牌号：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright frameNumber">
                    <label>车架号码：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                <div class="lineleft engineNumber">
                    <label>发动机号码：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright vehicleIdeNo">
                    <label>车辆识别号：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                <div class="lineleft displacement">
                    <label>排量：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright seats">
                    <label>车座数：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                <div class="lineleft newEnergy">
                    <label>是否新能源车：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright agentsLogo">
                    <label>是否喷涂执法执勤标识：</label>
                    <span>fafsd</span>
                </div>
            </div>
            
            <div class="line1 clearfix">
                <div class="lineleft unitIsno">
                    <label>车籍单位是否本单位：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright carRegisterUnit">
                    <label>车籍单位：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                <div class="lineleft compilingSituation">
                    <label>编制情况：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright taxonomy">
                    <label>车辆分类用途：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                <div class="lineleft legalType">
                    <label>执法执勤用车分类：</label>
                    <span>fafsd</span>
                </div>
                <div class="lineright workTotal">
                    <label>工作总量：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                ...
                <div class="lineright thisMileage">
                    <label>本年行驶里程：</label>
                    <span>fafsd</span>
                </div>
            </div>
            ...
            <div class="line1 clearfix">
                <div class="lineright allMileage">
                    <label>已行驶里程：</label>
                    <span>fafsd</span>
                </div>
...
<script>
    ...
    var grid8=mini.get("form9");
			...
			//财务信息
				...
				//裸车价
				var lcj = text.asset.carPrice; 
				$('.first-tabcont .line1 .carPrice span').html(lcj);
				//购置税
				var gzs = text.asset.purchaseTax; 
				$('.first-tabcont .line1 .purchaseTax span').html(gzs);
				//其他上户费
				var qtshf = text.asset.otherExpenses; 
				$('.first-tabcont .line1 .otherExpenses span').html(qtshf);
				//折旧状态
				var zjstau = text.asset.depreciationState; 
			...
			//购置信息	
				...
				//厂牌型号
				var cpnum = text.asset.labelType; 
				$('.first-tabcont .line1 .labelType span').html(cpnum);
				//车辆产地
				var caraddress = text.asset.origin; 
				$('.first-tabcont .line1 .origin span').html(caraddress);
				//保修截止日期
			...
			//使用信息
				...
				//车牌号
				var carnums = text.asset.plateNumber; 
				$('.first-tabcont .line1 .plateNumber span').html(carnums);
				//车架号
				var cjh = text.asset.frameNumber; 
				$('.first-tabcont .line1 .frameNumber span').html(cjh);
				//发动机号
				var fdjh = text.asset.engineNumber; 
				$('.first-tabcont .line1 .engineNumber span').html(fdjh);
				//车辆识别号
				var clsbh = text.asset.vehicleIdeNo; 
				$('.first-tabcont .line1 .vehicleIdeNo span').html(clsbh);
				//排量
				var pl = text.asset.displacement; 
				$('.first-tabcont .line1 .displacement span').html(pl);
				//车座数
				var czs = text.asset.seats; 
				$('.first-tabcont .line1 .seats span').html(czs);
				
				//是否新能源车
				var isnotxnyc = text.asset.newEnergy; 
				$('.first-tabcont .line1 .newEnergy span').html(isnotxnyc);
				//是否喷涂执法执勤标识
				var isnotptzfzq = text.asset.agentsLogo; 
				$('.first-tabcont .line1 .agentsLogo span').html(isnotptzfzq);
				//车籍是否本单位
				var isnotbdw = text.asset.unitIsno; 
				$('.first-tabcont .line1 .unitIsno span').html(isnotbdw);
				//车籍单位
				var cjdw = text.asset.carRegisterUnit; 
				$('.first-tabcont .line1 .carRegisterUnit span').html(cjdw);
				//编制情况
				var bzqk = text.asset.compilingSituation; 
				$('.first-tabcont .line1 .compilingSituation span').html(bzqk);
				//车辆用途分类
				var clytfl = text.asset.taxonomy; 
				$('.first-tabcont .line1 .taxonomy span').html(clytfl);
				//执法执勤用车分类
				var zfzqfl = text.asset.legalType; 
				$('.first-tabcont .line1 .legalType span').html(zfzqfl);
				//工作总量
				var gzsum = text.asset.workTotal; 
				$('.first-tabcont .line1 .workTotal span').html(gzsum);
				//权属证书编号
				var qszscode = text.asset.ownershipNumber; 
				$('.first-tabcont .line1 .ownershipNumber span').html(qszscode);
				//权属证书所有权人
				var qszsman = text.asset.certificateHave; 
				$('.first-tabcont .line1 .certificateHave span').html(qszsman);
				//权属证书发证时间
				var qszstime = ChangeDateFormat(text.asset.ownershipDate); 
				$('.first-tabcont .line1 .ownershipDate span').html(qszstime);
				//保管人
				...
				//本年行驶里程
				var bnxs = text.asset.thisMileage; 
				$('.first-tabcont .line1 .thisMileage span').html(bnxs);
				
				//已行驶里程
				var yxslc = text.asset.allMileage; 
				$('.first-tabcont .line1 .allMileage span').html(yxslc);
