                    ...
                    <div title="财务信息">
                        <div class="first-tabcont" id="firstForm">
                            ...
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>增加方式</label>
                                    <input id="combo2" name="additionMethod" class="mini-combobox" style="width:100%" textField="valued" valueField="types"  emptyText="请选择..." allowInput="true" onbuttonclick="combobox('zjfs','combo2')" popupHeight="100px" required="true" onvalidation="onComboValidation"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>计量单位</label>
                            ...
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineright boxline" style="display: none;">
                                    <label>资产大类</label>
                                    <input name="assetFirst" class="mini-textbox" style="width:100%" readonly value="6"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div title="购置信息">
                        <div class="first-tabcont" id="secondForm">
                            ...
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineleft boxline">
                                    <label>设备用途</label>
                                    <input id="combo21" name="usedType" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('sbyt','combo21')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div title="其他信息">
                        <div class="first-tabcont" id="fourthForm">
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineright boxline">
                                    <label>标签说明</label>
                                    <input name="labelDescription" class="mini-combobox" style="width:100%"/>
                                </div>
                            </div>
                            <div class="line1 clearfix ">
                                <!--<div class="lineleft boxline">
...
<script>
	...
	load();
		...
		combobox('sbyt','combo21');//设备用途
		combobox('sybm','combo8');//使用部门
		combobox('syfx','combo9');//使用方向
		combobox('syzt','combo10');//使用状态
//		combobox('zcdbzt','combo11');//资产调拨状态
