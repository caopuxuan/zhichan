                    ...
                    <div title="财务信息">
                        <div class="first-tabcont" id="firstForm">
                            ...
                            <div class="line1 clearfix ">
                                ...
                                <div class="lineleft boxline">
                                    <label>台式机分类</label>
                                    <input id="combo8" name="pcType" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('tsjfl','combo8')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>
                                <div class="lineleft boxline">
                                    <label>信息化设备分类</label>
                                    <input name="informationType" class="mini-textbox" style="width:100%"/>
                                </div>
                                <div class="lineright boxline" style="display: none;">
                                    <label>资产大类</label>
                                    <input name="assetFirst" class="mini-textbox" style="width:100%" readonly value="4"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div title="购置信息">
                        <div class="first-tabcont" id="secondForm">
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>入账形式</label>
                                    <input id="combo9" name="formEntry" class="mini-combobox" style="width:100%" textField="valued" valueField="types" emptyText="请选择..." allowInput="true" onbuttonclick="combobox('rzxs','combo9')" popupHeight="100px" onvalidation="onComboValidation"/>
                                </div>
                                <div class="lineright boxline">
                                    <label>会计凭证号</label>
                            ...
                            <div class="line1 clearfix ">
                                <div class="lineleft boxline">
                                    <label>产品序列号</label>
                                    <input name="productId" class="mini-textbox" style="width:100%"/>
                                </div>
                                <div class="lineleft boxline">
                                    <label>生产厂家</label>
                                    <input name="manufacturer" class="mini-textbox" style="width:100%"/>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
	...
	load();
		...
		combobox('tsjfl','combo8');//台式机分类
		combobox('rzxs','combo9');//入账形式
		combobox('sybm','combo10');//使用部门
		combobox('syfx','combo11');//使用方向
		combobox('syzt','combo12');//使用状态
//		combobox('zcdbzt','combo13');//资产调拨状态
